											...
											union() {
												translate(v = [0, 7.75, 0]) {
													difference() {
														...
														translate(v = [0, 0, 0.7000000000000002]) {
															translate(v = [0, -0.75, 0]) {
																cube(center = true, size = [5, 1.0, 2]);
															}
														}
													}
												}
